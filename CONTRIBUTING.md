...
* In Github, fork `https://github.com/pbstck/gowsdl` to your own account
* Get the package using "go get": `go get github.com/pbstck/gowsdl`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/pbstck/gowsdl/`
